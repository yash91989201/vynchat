...
export type UpdatePostOutputType = z.infer<typeof UpdateBlogOutput>;
export type DeletePostType = z.infer<typeof DeleteBlogInput>;
export type DeletePostOutputType = z.infer<typeof DeleteBlogOutput>;
